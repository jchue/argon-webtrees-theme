![Latest Release](https://img.shields.io/badge/release-v0.6.0-blue)
...
webtrees 2.0.6 (see [prior releases](https://github.com/jchue/argon-webtrees-theme/releases) for older versions)
